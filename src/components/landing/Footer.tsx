    ...
    <footer className="border-t border-white/[0.08] bg-brand-dark">
        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-white/70">
              Premium residential and commercial construction in Lucknow — built
              with quality, trust, and transparency.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-sm text-white/70">
                ...
                <span>kkaif2687@gmail.com</span>
              </li>

              <li className="flex items-start gap-3 text-sm text-white/70">
                <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-brand-gold" />
                <span>
                  42 Gomti Nagar Extension, Lucknow, Uttar Pradesh 226010, India
                </span>
              </li>
            </ul>
      ...
      <div className="border-t border-white/[0.08] px-6 py-5 lg:px-12">
        <p className="text-center text-sm text-white/60">
          © 2026 Adil Constructions. All rights reserved.
        </p>
      </div>
    </footer>
  )
